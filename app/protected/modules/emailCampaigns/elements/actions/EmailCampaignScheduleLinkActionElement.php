<?php
	...
	********************************************************************************/
    ...
    /**
     * Link element to take you to schedule the email campaign
     */
    class EmailCampaignScheduleLinkActionElement extends EditLinkActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('EmailCampaignsModule', '6. Schedule');
        }
        ...
        protected function getDefaultRoute()
        {
        	if (Yii::app()->request->getParam('id') != null) {
        		...
        		return Yii::app()->createUrl('emailCampaigns/default/schedule', $params);
        	} else return Yii::app()->createUrl('emailCampaigns/default/schedule');
        }
