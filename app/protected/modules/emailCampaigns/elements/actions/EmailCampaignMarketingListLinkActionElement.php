<?php
	...
	********************************************************************************/
    ...
    /**
     * Link element to take you to the select marketing list step
     */
    class EmailCampaignMarketingListLinkActionElement extends EditLinkActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('EmailCampaignsModule', '2. List');
        }
        ...
        protected function getDefaultRoute()
        {
        	if (Yii::app()->request->getParam('id') != null) {
        		...
        		return Yii::app()->createUrl('emailCampaigns/default/marketingList', $params);
        	} else return Yii::app()->createUrl('emailCampaigns/default/marketingList');
        }
