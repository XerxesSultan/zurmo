<?php
	...
	********************************************************************************/
    ...
    /**
     * Link element to take you to the preview for email campaign
     */
    class EmailCampaignPreviewLinkActionElement extends EditLinkActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('EmailCampaignsModule', '4. Preview');
        }
        ...
        protected function getDefaultRoute()
        {
        	if (Yii::app()->request->getParam('id') != null) {
        		...
        		return Yii::app()->createUrl('emailCampaigns/default/preview', $params);
        	} else return Yii::app()->createUrl('emailCampaigns/default/preview');
        }
