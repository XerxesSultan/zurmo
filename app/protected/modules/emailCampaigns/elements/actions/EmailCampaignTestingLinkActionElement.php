<?php
	...
	********************************************************************************/
    ...
    /**
     * Link element to take you to test for email campaigns
     */
    class EmailCampaignTestingLinkActionElement extends EditLinkActionElement
    {
        /**
         * @return string
         */
        ...
        {
            return Zurmo::t('EmailCampaignsModule', '5. Testing');
        }
        ...
        protected function getDefaultRoute()
        {
        	if (Yii::app()->request->getParam('id') != null) {
        		...
        		return Yii::app()->createUrl('emailCampaigns/default/testing', $params);
        	} else return Yii::app()->createUrl('emailCampaigns/default/testing');
        }
